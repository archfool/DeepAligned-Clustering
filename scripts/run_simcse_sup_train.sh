#!/usr/bin bash
    ...
    --model_name_or_path /media/archfool/data/data/huggingface/my-unsup-simcse-bert-base-uncased
    --train_file /media/archfool/data/data/datasets-for-clustering/clinc_sup_CL.tsv.csv
    --output_dir /media/archfool/data/data/huggingface/my-sup-simcse-bert-base-uncased
    --num_train_epochs 20
